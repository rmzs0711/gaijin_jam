...
std::shared_ptr<Hero> makeAssasinPurple(std::vector<std::vector<jam::Cell>>& map) {
    std::shared_ptr<Hero> monster = std::make_shared<Hero>
        ("data/images/MiniWorldSprites/Characters/Soldiers/Melee/PurpleMelee/AssasinPurple.png", 100, 0.1, map, 5);
...
std::shared_ptr<Hero> makeAssasinLime(std::vector<std::vector<jam::Cell>>& map) {
    std::shared_ptr<Hero> monster = std::make_shared<Hero>
        ("data/images/MiniWorldSprites/Characters/Soldiers/Melee/LimeMelee/AssasinLime.png", 120, 0.12, map, 5);
...
std::shared_ptr<Hero> makeAssasinCyan(std::vector<std::vector<jam::Cell>>& map) {
    std::shared_ptr<Hero> monster = std::make_shared<Hero>
        ("data/images/MiniWorldSprites/Characters/Soldiers/Melee/CyanMelee/AssasinCyan.png", 110, 0.8, map, 5);
...
std::shared_ptr<Hero> makeAssasinRed(std::vector<std::vector<jam::Cell>>& map) {
    std::shared_ptr<Hero> monster = std::make_shared<Hero>
        ("data/images/MiniWorldSprites/Characters/Soldiers/Melee/RedMelee/AssasinRed.png", 90, 0.14, map, 5);
